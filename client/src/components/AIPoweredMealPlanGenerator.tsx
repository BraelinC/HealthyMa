        ...
        <CardContent className="pt-6">
          <div className="flex items-center gap-3">
            ...
            <p className="text-sm text-gray-700">
              <strong>AI Status:</strong> Your intelligent meal planning assistant is configured and ready to generate personalized recommendations based on your priorities.
            </p>
          </div>
        </CardContent>
      </Card>
